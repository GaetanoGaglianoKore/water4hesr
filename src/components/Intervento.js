    ...
    <div>
      <nav className="navbar navbar-light bg-white shadow-sm px-3">
        ...
        <span className="navbar-brand mb-0">
          Intervento sul dispositivo {deviceId}
        </span>
      </nav>
      <div className="container my-4">
        ...
        <ul className="list-group">
          <li className="list-group-item d-flex justify-content-between align-items-center">
            ...
            <div>
              <button
                className="btn btn-checked btn-sm rounded-circle shadow-sm"
                aria-label="Segnala completato"
              >
                ✓
              </button>
            </div>
          ...
          <li className="list-group-item d-flex justify-content-between align-items-center">
            ...
            <div>
              <button
                className="btn btn-ar btn-sm rounded-circle shadow-sm"
                aria-label="Visualizza AR"
              >
                AR
              </button>
            </div>
